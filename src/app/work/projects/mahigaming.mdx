...
summary: "Pioneering game development, audio innovation, and a growing team at MahiGaming—building and releasing 20+ flagship games and 66+ slot titles for a global real-money platform while championing CI/CD, mentorship, and multidisciplinary collaboration."
team:
...
I joined MahiGaming in 2015 as a Game Developer and over the years grew into the role of Game Developer Group Lead, greatly contributing to the company's rise as a global real-money gaming platform. From day one, I dived headfirst into a fast-paced, collaborative startup atmosphere, helping build more than 20 flagship games and contributing to over 66 HTML5 slot titles. Early on, I integrated into the team for our core casino service game engine—designing its architecture to handle millions of concurrent users, optimizing performance for rapid global rollouts, and ensuring rock-solid stability under heavy load.
