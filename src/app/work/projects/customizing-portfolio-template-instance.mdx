...
For a refresh of my professional portfolio, I transitioned from a Weebly template site to a fully custom Next.js and OnceUI implementation, leveraging open‐source templates alongside my existing expertise in React.js, Webpack, and general web development.
